        ...
        return this.each(function() {
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("maxlength") !== undefined) {
              message = "Muito longo: máximo de '" + $this.attr("maxlength") + "' characters<!-- data-validation-maxlength-message to override -->";
            ...
            if ($this.attr("minchecked") !== undefined) {
              message = "Não foram verificadas opções suficientes; Mínimo de '" + $this.attr("minchecked") + "' required<!-- data-validation-minchecked-message to override -->";
